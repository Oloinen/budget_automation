...
module.exports = {
  ...
  seedUnknownItems,
  seedItemRules,
  // Convenience: seed using env-configured spreadsheet id
  async seedFromEnv(sheets) {
    const cfg = loadConfig();
    if (!cfg.testSpreadsheetId) {
      throw new Error('TEST_SPREADSHEET_ID is required for seedFromEnv');
    }
    return seedTestData(sheets, cfg.testSpreadsheetId);
  },
};
