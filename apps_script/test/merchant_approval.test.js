...
function loadFunctions() {
  const fn = new Function(
    ...
    'TAB_CC_STAGING', 'TAB_TRANSACTIONS_READY', 'TAB_CATEGORIES',
    'console',
...
describe('approveMerchantStagingEntries', () => {
  ...
  test('processes multiple entries in single run', () => {
    // Valid entry
    stagingSheet.appendRow([
      "tx-006", "2026-01-05", "Store1", 10, "unknown", "Food", "Groceries", "", STATUS_NEEDS_RULE
    ]);
    // Another valid entry
    stagingSheet.appendRow([
      "tx-007", "2026-01-06", "Store2", 20, "review", "Transport", "Gas", "", STATUS_NEEDS_REVIEW
    ]);
    // Invalid entry
    stagingSheet.appendRow([
      "tx-008", "2026-01-07", "Store3", 30, "unknown", "Bad", "Category", "", STATUS_NEEDS_RULE
    ]);
  ...
  test('extracts month from date correctly', () => {
    stagingSheet.appendRow([
      "tx-009", "2026-03-15", "Store", 40, "unknown", "Food", "Groceries", "", STATUS_NEEDS_RULE
    ]);
